...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${basePath}/sharebook/css/jquery-ui.css">
            ...
            <div class="bodyPage_body_insert_bookdetail">
                <div style="width: 100%;margin-top: 20px">
                    ...
                    <form id="form_insert_q" class="form-inline" role="form" style="width: 95%;margin: auto;margin-top: 20px;"
                        ...
                        <div class="form-group" style=" display:inherit;margin-left: 40px;margin-top:20px">
...
<script>
    ...
    $('#formInsertBtn').on('click', function () {
        $.ajax({
            ...
            url : "/ideaWorkSpace/bookshare/insertauctionbook",    //请求发送到TestServlet处
