...
<div id="sharebookuserList" class="panel panel-default" style="padding-right: 0px;">
    <div>
        <form id="form_sharebookuser_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
            ...
            <div class="form-group" style="margin-left: 50px;">
                <label onclick="$(this).next().focus();">出借人</label> <input
                    name="sellerUser" type="text" class="form-control" placeholder="出借人查询"/>
            </div>
            <div class="form-group" style="margin-left: 50px;">
...
<script type="text/javascript">
    ...
    function detailTableDialog(e, value, row, index){
        ...
        $('#detailTable').bootstrapTable('refresh',{
            url: '/ideaWorkSpace/book/recordborrow',
            query:{
                auctionId:auctionId
            }
        });
    ...
    function audited(){
        ...
        if(flag){
            ...
            var params = {ids:ids};
            $.ajax({
                url: "/ideaWorkSpace/book/auditBookBorrow",    //请求的url地址
    ...
    function reject(){
        ...
        if(flag){
            ...
            var params = {ids:ids};
            $.ajax({
                url: "/ideaWorkSpace/book/auditNotBookBorrow",    //请求的url地址
                dataType: "json",   //返回格式为json
                data: JSON.stringify(params),    //参数值
                type: "POST",   //请求方式
                contentType:"text/html;charset=utf-8",
