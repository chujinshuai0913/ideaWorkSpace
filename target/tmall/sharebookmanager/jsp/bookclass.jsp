    ...
    <div>
        <form id="form_sharebookuser_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
            ...
            <div class="form-group" style="margin-left: 50px;">
                <label onclick="$(this).next().focus();">一级分类名称</label> <input
                    name="className1" type="text" class="form-control" placeholder="分类名称模糊查询"/>
            </div>
            <div class="form-group" style="margin-left: 50px;">
            ...
            <div class="form-group" style="margin-left: 30px;">
                ...
                <button type="button" id="insertSearchBtn" class="btn btn-primary" data-style="zoom-in"
                        formaction="javascript:void(0);">新增一级分类
                </button>
            </div>
            <div class="form-group" style="margin-left: 30px;">
    ...
    <div class="modal-dialog" dialog-width="900px" style="width:900px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalTitle">二级分类</h4>
                <form id="form_sell_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
                      onkeydown="if(event.keyCode==13){return false;}">
                    <div class="form-group" style="margin-left: 50px;">
                        <label onclick="$(this).next().focus();">二级分类名称</label> <input
                            name="className2" type="text" class="form-control" placeholder="分类名称模糊查询"/>
                    </div>
                    <div class="form-group" style="margin-left: 50px;">
                        <label onclick="$(this).next().focus();">状态</label>
                        <select type="text" name="status"  class="form-control" >
                    ...
                    <div class="form-group" style="margin-left: 30px;">
                        ...
                        <button type="button" id="insertClass2" class="btn btn-primary" data-style="zoom-in"
                                formaction="javascript:void(0);">新增二级分类
                        </button>
                    </div>
                    <div class="form-group" style="margin-left: 30px;">
                ...
                <div class="modal-header">
                    ...
                    <form id="form_insertClass1_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
                        ...
                        <div class="form-group" style="margin-left: 50px;">
                            ...
                            <input name="className1" type="text" class="form-control" placeholder="分类名称"/>
                        </div>
...
<script type="text/javascript">
    ...
    $table.bootstrapTable({
        ...
        url: '/ideaWorkSpace/book/bookclass1',
        showColumns: false,
        method:'post',
        dataType: "json",
