        ...
        <form id="form_sharebookuser_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
            ...
            <div class="form-group" style="margin-left: 50px;">
                <label onclick="$(this).next().focus();">昵称</label> <input
                    name="userName" type="text" class="form-control" placeholder="昵称模糊查询"/>
            </div>
            <div class="form-group" style="margin-left: 50px;">
            ...
            <div class="form-group" style="margin-left: 50px;">
                ...
                <select  name="status" type="text" class="form-control" placeholder="学号">
...
<script type="text/javascript">
    ...
    $table.bootstrapTable({
        ...
        url: '/ideaWorkSpace/usershare/userlistData',
        showColumns: false,
        method:'post',
        dataType: "json",
