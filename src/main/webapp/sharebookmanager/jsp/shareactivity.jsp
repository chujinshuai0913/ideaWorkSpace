    ...
    <div>
        <form id="form_sharebookuser_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
            ...
            <div class="form-group">
                <label for="startTime" style="width: 90px;">活动日期</label>
                <div class="input-group date">
                    <input type="text" class="form-control" style="width: 147px;"
                           id="startTime" name="startTime"
                           placeholder="活动日期(开始)"> <span class="input-group-addon"><i
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                    <input type="text" class="form-control" style="width: 147px;"
                           id="finshTime" name="finshTime" placeholder="活动日期(结束)">
                    <span class="input-group-addon"><i
                            class="glyphicon glyphicon-th"></i></span>
                </div>
            </div>
            <div class="form-group" style="margin-left: 50px;">
                <label onclick="$(this).next().focus();">活动名称</label> <input
                    name="name" type="text" class="form-control" placeholder="活动名称模糊查询"/>
            </div>
            <div class="form-group" style="margin-left: 50px;">
            ...
            <div class="form-group" style="margin-left: 30px;">
                ...
                <button type="button" id="insertSearchBtn" class="btn btn-primary" data-style="zoom-in"
                        formaction="javascript:void(0);">活动新建
                </button>
            </div>
            <div class="form-group" style="margin-left: 30px;">
                <button type="button" class="btn btn-success" onclick="reject()">删除</button>&nbsp;&nbsp;
                <button type="button" class="btn btn-success" onclick="audited()">恢复</button>
            </div>
        </form>
    </div>
    ...
    <div class="modal-dialog" dialog-width="900px" style="width:900px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalTitle">信息公告</h4>
                <form id="form_sell_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
                    ...
                    <input name="activityId" id="activityId1" type="text" class="form-control" style="display: none" />
                    <div class="form-group" style="margin-left: 30px;">
                        <label></label>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form id="form_insertClass1_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
                      onkeydown="if(event.keyCode==13){return false;}">
                    <div class="form-group" style="margin-left: 50px;">
                        <label onclick="$(this).next().focus();" style="width: 90px;">活动名称</label>
                        <input name="name" type="text" class="form-control" placeholder="活动名称"/>
                    </div>
                    <div class="form-group" style="margin-left: 50px;">
                        <label onclick="$(this).next().focus();" style="width: 90px;">活动地点</label>
                        <input name="activityRoom" type="text" class="form-control" placeholder="活动地点"/>
                    </div>
                    <div class="form-group" style="margin-left: 50px;">
                        <label for="startTime" style="width: 90px;" onclick="$(this).next().focus();">活动日期</label>
                        <div class="input-group date">
                            <input type="text" class="form-control" style="width: 147px;"
                                   id="start2Time" name="startTime"
                                   placeholder="活动日期"> <span class="input-group-addon"><i
                                class="glyphicon glyphicon-th"></i></span>
                        </div>
                    </div>
                    <div class="form-group" style="margin-left: 50px;">
                        <label onclick="$(this).next().focus();"style="width: 90px;">活动内容</label>
                        <textarea name="remark" style="width: 400px" type="text" class="form-control" placeholder="活动内容"></textarea>
                    </div>
            ...
            <div class="modal-header">
                ...
                <form id="form_insertClass2_q" class="form-inline" role="form" style="width: 95%;margin: auto;"
                    ...
                    <div class="form-group" style="margin-left: 50px;">
                        ...
                        <input name="activityId" id="activityId" type="text" class="form-control" style="display: none" />
...
<script type="text/javascript">
    ...
    $table.bootstrapTable({
        ...
        url: '/ideaWorkSpace/share/shareactivitylist',
        showColumns: false,
        method:'post',
        dataType: "json",
    ...
    function audited(){
        ...
        if(flag){
            ...
            var params = {ids:ids};
            $.ajax({
                url: "/ideaWorkSpace/share/auditactivity",    //请求的url地址
    ...
    function reject(){
        ...
        if(flag){
            ...
            var params = {ids:ids};
            $.ajax({
                url: "/ideaWorkSpace/share/auditNotactivity",    //请求的url地址
                dataType: "json",   //返回格式为json
                data: JSON.stringify(params),    //参数值
                type: "POST",   //请求方式
                contentType:"text/html;charset=utf-8",
    ...
    $('#insert1').on('click',function(){
        $.ajax({
            url: "/ideaWorkSpace/share/insertactivity",    //请求的url地址
            dataType: "json",   //返回格式为json
