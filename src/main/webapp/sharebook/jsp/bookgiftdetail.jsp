		...
		<div class="bodyPage_body">
			<div class="bodyPage_body_bookdetail_up">
				<div class="bodyPage_body_bookdetail_up_up">
					<p><span>
					<c:if test='${requestScope.bookGiftVo.selfStatus==1}'>  自营:${requestScope.bookGiftVo.sellerName} </c:if>
					<c:if test='${requestScope.bookGiftVo.selfStatus==0}'> 商家: ${requestScope.bookGiftVo.sellerName}</c:if>
					</span>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;感谢您的到来！</p>
				</div>
				<div class="bodyPage_body_bookdetail_up_left">
					...
					<div class="bodyPage_body_bookdetail_up_left_text">
						<p class="bodyPage_body_bookdetail_up_left_text_title">${requestScope.bookGiftVo.bookName}</p>
						<p class="bodyPage_body_bookdetail_up_left_text_detail">
							<input id="bookId" type="text" type="text" style="display: none" value="${requestScope.bookGiftVo.id}">
							<span class="span_1">赠书人:<a href="#"><span>${requestScope.bookGiftVo.sellerName}</span></a> </span>
							<input id="sellerId" type="text" type="text" style="display: none" value="${requestScope.bookGiftVo.sellerId}">
							<span class="span_1"> 上传时间：<span>${requestScope.bookGiftVo.uTime} </span></span>
						</p>
						<div class="bodyPage_body_bookdetail_up_left_text_ziying">
							介绍:<span class="span_2 zwjs" style="margin-left: 0px;height: 100px;width: 80%">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${requestScope.bookGiftVo.remark}
						       </span>
							<span class="span_2" style="margin-left: 0px">
                                  <input type="text" id="useableNum" style="display: none" value="${requestScope.bookGiftVo.useableNum}">
                                 <input type="text" id="skuId" style="display: none" value="${requestScope.bookGiftVo.skuId}">
						    	  	待赠书量：<span style="color: green; margin-right: 20px;"> ${requestScope.bookGiftVo.useableNum}</span>
						            受赠数量:
    ...
    $(function () {
        $("#insertMyBook").on('click',function () {
            ...
            if(useableNum<=0){
                ...
                insertBookCat($("#bookId").val(),$(".input_buy").val(),$("#sellerId").val(),3,0,$("#skuId").val());
            }
        })
        //加入书箱
