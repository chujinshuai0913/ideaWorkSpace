                ...
                <div style="width: 100%;margin-top: 20px">
                    ...
                    <form id="form_insert_q" class="form-inline" role="form" style="width: 95%;margin: auto;margin-top: 20px;"
                        ...
                        <div class="form-group" style="margin-left: 40px;">
                            ...
                            <input  style="margin-left:25px"  name="bookName" type="text" class="form-control" placeholder="书名"/>
                        </div>
                        <div class="form-group" style="margin-left: 40px;margin-top: 20px;">
                            <label onclick="$(this).next().focus();">价格</label>
                            <input  style="margin-left: 25px"  name="price" type="text" class="form-control" placeholder="价格"/>
                        </div>
                        <div class="form-group" style="margin-left: 40px;margin-top: 20px">
...
<script>
    ...
    $('#formInsertBtn').on('click', function () {
        $.ajax({
            ...
            url : "/ideaWorkSpace/bookshare/insertsellbook",    //请求发送到TestServlet处
