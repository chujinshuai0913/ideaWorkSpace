				...
				<div class="bodyPage_body_bookdetail_up_left">
					<div class="bodyPage_body_bookdetail_up_left_img">
						<div style="cursor:pointer;width: 100%;height: 80%">
								<img class="imgBookBig" style="width: 100%;height: 100%;" src="${basePath}/sharebook/img/book/${requestScope.bookSellingVo.src1}" alt="">
						</div>
						<div style="width: 100%;height: 20%;">
							<div style="border-top: 1px gainsboro solid;cursor:pointer;width: 25%;height: 100%;float: left">
								<img class="imgBook"  style="" src="${basePath}/sharebook/img/book/${requestScope.bookSellingVo.src1}" alt="">
							</div>
							<div style="border-top: 1px gainsboro solid;border-left: 1px gainsboro solid;cursor:pointer;width: 25%;height: 100%;float: left">
								<img class="imgBook"  style="width: 100%;height: 100%;" src="${basePath}/sharebook/img/book/${requestScope.bookSellingVo.src2}" alt="">
							</div>
							<div  style="border-top: 1px gainsboro solid;border-left: 1px gainsboro solid;cursor:pointer;width: 25%;height: 100%;float: left">
								<img class="imgBook"  style="width: 100%;height: 100%;" src="${basePath}/sharebook/img/book/${requestScope.bookSellingVo.src3}" alt="">
							</div>
							<div  style="border-top: 1px gainsboro solid;border-left: 1px gainsboro solid;cursor:pointer;width: 24%;height: 100%;float: left">
								<img class="imgBook"  style="width: 100%;height: 100%;" src="${basePath}/sharebook/img/book/${requestScope.bookSellingVo.src4}" alt="">
							</div>
						</div>
					</div>
