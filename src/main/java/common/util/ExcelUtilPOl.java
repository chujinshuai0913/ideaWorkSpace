...
import common.model.ExcelBeanPol;
 ...
 */
    public class ExcelUtilPOl {
         ...
         */
        public static XSSFWorkbook createExcelFile(Class clazz, List objs, Map<Integer, List<ExcelBeanPol>> map, String sheetName) throws
         ...
         */
        public static final void createTableHeader(XSSFSheet sheet, Map<Integer, List<ExcelBeanPol>> map) {
            int startIndex=0;//cell起始位置
            int endIndex=0;//cell终止位置
            for (Map.Entry<Integer, List<ExcelBeanPol>> entry : map.entrySet()) {
                XSSFRow row = sheet.createRow(entry.getKey());
                List<ExcelBeanPol> excels = entry.getValue();
        ...
        public static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBeanPol>> map, List objs, Class clazz)
                throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, IntrospectionException,
                ClassNotFoundException, ParseException {
            int rowindex = map.size();
            int maxKey = 0;
            List<ExcelBeanPol> ems = new ArrayList<>();
            for (Map.Entry<Integer, List<ExcelBeanPol>> entry : map.entrySet()) {
            ...
            for (Object obj : objs) {
                ...
                for (int i = 0; i < ems.size(); i++) {
                    ExcelBeanPol em = (ExcelBeanPol) ems.get(i);
                    // 获得get方法
