...
public class TypeProfessional2 extends QueryParam implements Serializable {
    private Integer id;
    ...
    public TypeProfessional2(Integer id, Integer classId1, String className2, Integer printUser, Integer printTime, Integer importUser, Integer importTime, Integer exportUser, Integer exportTime, Integer cT, Integer cU, Integer status) {
        this.id = id;
