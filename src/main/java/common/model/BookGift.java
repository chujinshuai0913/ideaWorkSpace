...
public class BookGift {
    ...
    public BookGift(Integer id, Integer skuId, Integer sellerId, String bookName, String remark, String src1, String src2, String src3, String src4, Integer status, Integer uploadTime, Integer dealTime, Integer useableNum, Integer useNum, Integer preNum, Integer state, Integer cU, Integer cT, Integer printUser, Integer printTime, Integer importUser, Integer importTime, Integer exportUser, Integer exportTime, Integer flag, String pricingunit, Integer bookType2, Integer bookType1, String bookTypeName2, String bookTypeName1, Integer professionalType1, Integer professionalType2, String professionalTypeName1, String professionalTypeName2) {
        this.id = id;
        this.skuId = skuId;
